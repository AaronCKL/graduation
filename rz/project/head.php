...
<link rel="stylesheet" href="/rz/project/css/project.css">
<title>安徽融资网</title>
...
<div class="rz-head-nav">
  <ul class="rz-nav">
       <li class=""><a href="/rz/index.php">首页</a></li>
       <li class=""><a href="/rz/finance/index.php" >找资金</a></li>
       <li class="active"><a href="/rz/project/index.php" >找项目</a></li>
...
<div class="modal fade md-modal" id="message-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-5">
      <button type="submit" class="btn btn-danger form-control">发送</button>
    </div>
  </div>
</form>
      </div>
