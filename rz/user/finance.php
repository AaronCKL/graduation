...
<div class="user">
  ...
  <div class="form-group">
    <label for="money" class="col-sm-2 control-label">融资金额</label>
    <div class="col-sm-6">
  ...
  <div class="form-group">
    <label for="content" class="col-sm-2 control-label">项目概述</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label for="content_1" class="col-sm-2 control-label">项目优势</label>
    <div class="col-sm-10">
