...
<div class="container clearfix">
   ...
   mysql_select_db($mysql_dbname, $con);
      $chec = mysql_query("select * from invest where ID = $aa"); 
     ...
     echo '<tr>
                            ...
                            <tr>
                                ...
                                <td><img style="width: 200px;height: 100px;" src="/rz/img/invest/'.$re['imgName'].'"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>资讯：</th>
                                <td>
                                <div id="txtDiv" style="border:1px solid #cccccc; height:400px;width:700px;">
                                    '.$re['content'].'<br/>'.$re['contentAdv'].'<br/>'.$re['remarks'].'
                                </div>
                                </td>
                            </tr>';
     } 
