    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="new_addPush.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input name="inputfile" id="inputfile" type="file"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>资讯：</th>
                                <td>
                                <div id='txtDiv' style='border:1px solid #cccccc; height:400px;width:700px;'></div>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    ...
                                    <input class="btn btn-primary btn6 mr10" value="发布" type="submit" onclick="saveContent()">
