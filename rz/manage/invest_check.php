...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">资金管理</a><span class="crumb-step">&gt;</span><span>待审核资金</span></div>
        </div>
   ...
   mysql_select_db($mysql_dbname, $con);
    $chec = mysql_query("select * from invest where visible = 0"); 
   ...
   {  
     echo '<tr>
                            ...
                            <td>'.$re["money"].'</td>
                            <td>
                            <button type="button" class="btn btn-primary" onclick=investCheck('.$re["ID"].',1)>删除</button>
                            <button class="btn btn-primary"><a style="color: #fff" href=invest_detail.php?id='.$re["ID"].'>详情</a></button>
                            <button type="button" class="btn btn-primary" onclick=investCheck('.$re["ID"].',2)>审核通过</button>
                            </td> 
                        </tr>';
  } 
  mysql_close($con);
